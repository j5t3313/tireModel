#!/usr/bin/env python3
"""
Script to prebuild all F1 tire models for faster Streamlit app loading.
Run this script once to generate all models, then use the optimized app.
"""
...
class F1ModelPrebuilder:
    def __init__(self, output_dir="prebuilt_models"):
        ...
        # 2025 F1 Calendar (same as in your app)
        self.circuit_data = [
